...
import {type CalculatorInputFields, cystatinUnits, genderTypes, type GenderTypes, ResultEvent,} from "../../types";
        ...
        return html`
            <div class="calc-wrapper">
                <calc-description>
                    ...
                    <p slot="description">
                        Die eGFR (geschätzte glomeruläre Filtrationsrate) kann auch unter Verwendung von Cystatin C
                        anstelle von Kreatinin berechnet werden,
