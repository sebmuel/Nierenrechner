...
export class ResultModal extends LitElement {
    static styles = [
        ...
        css`
            ...
            .modal .header .close {
                background-color: var(--app-theme-primary, #fff);
                appearance: none;
                outline: none;
                border: var(--app-modal-close-button-border-width, 1px) solid var(--app-modal-close-button-border-color-rgb, transparent);
