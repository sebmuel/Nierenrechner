...
export const appStyles = css`
  ...
  *::after {
  ...
  .calc-wrapper button[type="submit"] {
    background-color: var(--app-button-background-color, #ffffff);
    appearance: none;
    outline: none;
    border: var(--app-button-border-width, 1px) solid var(--app-input-border-color-rgb, rgb(0, 0, 0));
  ...
  .calc-wrapper button[type="submit"]:hover {
    background-color: var(--app-button-background-color-hover, #020202);
    color: var(--app-button-font-color-hover, #fff);
